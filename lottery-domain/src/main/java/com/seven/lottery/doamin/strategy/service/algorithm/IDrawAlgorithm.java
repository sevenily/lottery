package com.seven.lottery.doamin.strategy.service.algorithm;
...
public interface IDrawAlgorithm {
     ...
     * @param awardRateList     奖品概率配置集合「值示例：AwardRateInfo.awardRate = 0.04」
     */
    void initRateTuple(Long strategyId, Integer strategyMode, List<AwardRateVO> awardRateList);
